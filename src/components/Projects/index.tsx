...
const { Icons, Images } = helpers;
const {
  Id, Title, SubTitle, ProjectList,
} = constants.DataPage.en.Project;
    ...
    <div id={Id} className="lg:flex flex-col items-center">
      ...
      <div className="box-border lg:bg-[#484747] px-4 lg:px-24 lg:w-full">
        {ProjectList.map((e, index) => (
          <div
            className={`text-[#eae7ea] bg-[#484747] w-full my-5 lg:my-10 p-3 lg:p-4 rounded-md lg:rounded-lg lg:relative lg:flex items-center ${index % 2 !== 0 ? 'justify-end' : 'justify-start'
            }`}
          >
            <div
            ...
            <div
              className={`box-border lg:w-[50%] lg:absolute lg:p-5 lg:rounded-md lg:shadow-md lg:bg-slate-500/60 backdrop-blur-sm hover:backdrop-blur-lg hover:lg:bg-slate-500/80 transition-all ${index % 2 !== 0 ? 'left-0' : 'right-0'}`}
            >
